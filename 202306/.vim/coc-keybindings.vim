" このファイルの内容は https://github.com/neoclide/coc.nvim/blob/master/README.md のうち、キーバインドの設定記述部分をダウンロードしたものです
" ライセンスは coc.nvim に準じます https://github.com/neoclide/coc.nvim/blob/master/LICENSE.md
"
...
" 
" The individual or the legal entity must conspicuously display, without modification, this License and the notice on each redistributed or derivative copy of the Licensed Work.
" 
